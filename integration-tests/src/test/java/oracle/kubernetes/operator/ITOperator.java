...
public class ITOperator extends BaseTest {
  ...
  @Test
  public void testCustomSitConfigOverrides20() throws Exception {
    Assume.assumeFalse(QUICKTEST);
    String testMethod = new Object() {}.getClass().getEnclosingMethod().getName();
    logTestBegin(testMethod);

    if (operator2 == null) {
      operator1 = TestUtils.createOperator(operator2File);
    }
    ...
    try {
      ...
      Files.copy(
          new File(createDomainScriptDir + "/create-domain-auto-custom-sit-config20.py").toPath(),
          new File(createDomainScriptDir + "/create-domain.py").toPath(),
          StandardCopyOption.REPLACE_EXISTING);
